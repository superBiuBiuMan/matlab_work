clc,close all;
%https://blog.csdn.net/weixin_40647819/article/details/80377343
clear;
img_in=imread('666.jpg');
...
img_bw=imbinarize(img_in,thresh);%二值图像
img_bwtemp=img_bw;
%%%%step1:高斯滤波
...
grad_dirtemp=grad_dir;
grad_dir=grad_dir*180/pi;%转角度
%%%%step3:对梯度幅值进行非极大值抑制
